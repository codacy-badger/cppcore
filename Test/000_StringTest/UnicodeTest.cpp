...
TEST(UnicodeTest, WCSConvert)
{
	...
	{
        FILE* pFile = nullptr;
		ASSERT_EQ(0, fopen_s(&pFile, "../Data/Unicode/UTF8Sample.txt", "rb"));
	...
	{
		FILE* pFile = nullptr;
		ASSERT_EQ(0, fopen_s(&pFile, "../Data/Unicode/UTF16Sample.txt", "rb"));
		ASSERT_NE(pFile, (FILE*)NULL);
	...
	{
		FILE* pFile = nullptr;
		ASSERT_EQ(0, fopen_s(&pFile, "../Data/Unicode/UTF32Sample.txt", "rb"));
		ASSERT_NE(pFile, (FILE*)NULL);
	...
	{
		FILE* pFile = nullptr;
		ASSERT_EQ(0, fopen_s(&pFile, "../Data/Unicode/ASCIISample.txt", "rb"));
		ASSERT_NE(pFile, (FILE*)NULL);
