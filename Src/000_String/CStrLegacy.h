...
namespace core
{
	...
	const char* SafeStrStr(const char* pszDest, size_t tDestCch, const char* pszSubStr);
	const wchar_t* SafeStrStr(const wchar_t* pszDest, size_t tDestCch, const wchar_t* pszSubStr);
	...
	size_t SafeFindStr(const char* pszDest, size_t tDestCch, const char* pszKey);
