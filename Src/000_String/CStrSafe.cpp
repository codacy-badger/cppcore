...
{
    //////////////////////////////////////////////////////////////////////////
    constexpr size_t g_tCharSize = sizeof(TCHAR);
    constexpr size_t g_tMaxCchLength = 0x7FFFFFFF;

    //////////////////////////////////////////////////////////////////////////
    static inline ECODE StringCchCopyWorker(LPTSTR pszDest, size_t tDestCch, LPCTSTR pszSrc, size_t tCopyCch)
    {
        ...
        const size_t tFinalSrcCch = std::min(tSrcCch, tCopyCch);
        const size_t tFinalCopyCch = std::min(tFinalSrcCch, tDestCch-1);
    ...
    //////////////////////////////////////////////////////////////////////////
    static inline ECODE StringCchVPrintfWorker(LPTSTR pszDest, size_t tDestCch, LPCTSTR pszFormat, va_list vaList)
    {
...
#else
        const int nWritten = vsntprintf(pszDest, tDestCch, pszFormat, vaList);
#endif

        const size_t tNullIndex = tDestCch-1;
    ...
    //////////////////////////////////////////////////////////////////////////
    static inline ECODE StringCchGetsWorker(LPTSTR pszDest, size_t tDestCch)
    {
        if( 0 == tDestCch )
            return EC_INVALID_ARGUMENT;
    ...
    //////////////////////////////////////////////////////////////////////////
    static inline ECODE StringCchLengthWorker(LPCTSTR pszContext, size_t tContextBuffLen, size_t* pLengthCch)
    {
        if( pLengthCch )
            *pLengthCch = 0;
    ...
    {
        const size_t tPrevLength = SafeStrLen(pszDest, tDestCch);
        pszDest += tPrevLength;
    ...
    //////////////////////////////////////////////////////////////////////////
    static inline ECODE StringExWorker(LPTSTR pszDest, size_t tDestCch, ECODE nRet, LPTSTR* ppszDestEnd, size_t* pRemainCch, DWORD dwFlags)
    {
